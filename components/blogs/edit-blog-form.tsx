...
import { getDefaultEditorConfig, handleImageUpload, MAX_FILE_SIZE } from "@/lib/tiptap-utils"
...
export function EditBlogForm({
  ...
  const jsonContent = useMemo(() => {
    if (!blog?.jsonContent?.length) return null;
    try {
      return JSON.parse(blog.jsonContent);
    } catch {
