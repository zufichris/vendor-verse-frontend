          ...
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <div className="relative group">
                <Link href="/products" className="text-gray-700 hover:text-black transition-colors flex items-center">
                  Products
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="p-2 space-y-1">
                    <Link href="/about" className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded">
                      About Us
                    </Link>
                    <Link href="/contact" className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded">
                      Contact
                    </Link>
                    <Link href="/careers" className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded">
                      Careers
                    </Link>
                    <Link href="/press" className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded">
                      Press
                    </Link>
                  </div>
                </div>
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="p-2 space-y-1">
                    <Link href="/help" className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded">
                      Help Center
                    </Link>
                    <Link href="/contact" className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded">
                      Contact Us
                    </Link>
                    <Link href="/shipping" className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded">
                      Shipping Info
                    </Link>
                    <Link href="/returns" className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded">
                      Returns
                    </Link>
                  </div>
                </div>
